(() => {
  ...
  function findMembersTable() {
    return [...document.querySelectorAll("table")].find((table) => {
      ...
      return text.includes("nom") && text.includes("membre depuis") && text.includes("rôles");
    });
  }
  ...
  function getScroller() {
    ...
    if (!table) {
      console.warn("[Kaly Fluxer] Table membres introuvable.");
      return null;
    }
    ...
    if (!(verticalScroller instanceof HTMLElement)) {
      console.warn("[Kaly Fluxer] Scroller introuvable.");
      return null;
    }
  ...
  console.log("[Kaly Fluxer] Scroll membres activé avec boutons violets.");
})();